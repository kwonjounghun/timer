...
import RetrospectiveFeature from './features/retrospective/RetrospectiveFeature';
...
type ActiveSection = 'timer' | 'checklist' | 'todo' | 'links' | 'conceptmap' | 'retrospective';
...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    const updateSectionFromURL = () => {
      ...
      if (section && (section === 'timer' || section === 'checklist' || section === 'todo' || section === 'links' || section === 'conceptmap' || section === 'retrospective')) {
